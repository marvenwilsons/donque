const routine1 = require('./test/routine-1')
...
const test = async (routine, index) => {
    const flow = setInterval(() => {
        ...
        const finalresult = {
            ...
            set value(val) {
                if (val === true) {
                    ...
                    console.log('')
                    console.log(` TEST #${count + 1} FAIL! `.bgRed.bold, ` ${routine[count].description} `.red.bold)
                    console.log('')
        ...
        // desc
        console.log(` TEST #${count + 1} ${routine[count].description} `.bgBlue.bold);
        // hooks
                    ...
                    if (err) {
                        ...
                        if (_err == undefined && isDone == false) {
                            ...
                            setTimeout(() => {
                                ...
                                console.log('')
                                routine.map((e,i) => {
                                    console.log('\t',` Test #${i + 1} `.bgGreen.bold,`${e.description}`.green)
                                    console.log('')
                                })
                            }, 2000);
                        }
