<template>
  ...
  >
    <div style="border-bottom:2px solid #DFE3E8">
      <!-- search bar here -->
      <div
      ...
      >
        ...
        <div class="flex fullwidth flexwrap">
          ...
          <div
            ...
            class="flex flexcenter margin025 padright050 padleft050 borderRad4"
          >
          ...
          <div
            @click="addItem"
            :style="{borderRadius:'2px',background:'white', width: '30px', border: `1px solid ${appearance.borderColor}`, fontWeight:'100', color: '#566470'}"
        ...
        <!--  -->
        <div v-if="inputData" class="flex flexend margintop050 marginbottom050">
          <span
            :style="{borderRadius:'3px',color:appearance.textColor}"
            class="padleft050 padright050 padtop025 padbottom025"
