      ...
      <div v-if="ready" id="dq-init-wrapper" class="flex flexwrap">
        <div class="fullwidth" id="tc-f-wrap-admn">
          <div class="pad125">
            ...
            <span>
              This form is for creating the "User adminstrator" in "Admin database" in mongodb database,
              this form should not be used for creating an "application admin", use the "Add new application admin" instead.
            </span>
          </div>
...
export default {
  data() {
    return {
      ...
      role: "read",
      passed: [],
      roles: [{roleTitle:'read'},{roleTitle:'readWrite'},{roleTitle:'write'}],
      errors: {
        username: [],
        password: [],
        repassword: [],
  ...
  beforeCreate() {
    this.$store.commit("pane_system/set_pane_config", {
      target: "Admin",
      title: "Admin Database Form For MongoDb",
      pane_width: "700px"
    });
  }
};
